...
Currently, after exploring machine learning (namely neural networks) from research and studies, Timothy has decided to currently work on a book on neural networks. This book attempts to bridge the gaps between theoretical foundations of neural networks, their development, and application. 
